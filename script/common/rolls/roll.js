export async function rollAttribute(characterName, attribute, diceCount, imagePath = "systems/conan2d20/asset/image/unknown-actor.png") {
  rollDiceTest(characterName, attribute.name, diceCount, attribute.value, 0, 20, imagePath);
}
...
export async function rollSkill(characterName, skill, attribute, diceCount, imagePath = "systems/conan2d20/asset/image/unknown-actor.png") {
  ...
  rollDiceTest(characterName, skill.name, diceCount, diceTarget, skill.focus, 20, imagePath);
}

async function rollDiceTest(characterName, testName, diceCount, diceTarget, focusThreshold, complicationThreshold, imagePath) {
